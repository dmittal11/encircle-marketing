...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Holiday'), ['action' => 'edit', $userHoliday->User_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Holiday'), ['action' => 'delete', $userHoliday->User_id], ['confirm' => __('Are you sure you want to delete # {0}?', $userHoliday->User_id)]) ?> </li>
